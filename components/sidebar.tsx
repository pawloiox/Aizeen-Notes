      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 left-0 bottom-0 z-50 w-72 bg-zinc-950 border-r border-zinc-800 shadow-2xl flex flex-col"
          >
            <div className="h-16 flex items-center justify-between px-4 border-b border-zinc-800">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xl font-medium tracking-tight text-zinc-50">Notes</span>
              </div>
              <button
                onClick={onClose}
                className="p-2 -mr-2 rounded-full hover:bg-zinc-900 transition-colors text-zinc-400 hover:text-zinc-100"
              >
                <X size={20} />
              </button>
            </div>
                ...
                <div className="flex flex-col gap-1 px-2">
                  {sortedNotes.map((note) => (
                    <button
                      ...
                      className="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-zinc-900 transition-colors text-left group"
                    >
                      {note.pinned ? (
                        <Pin size={16} className="text-zinc-500 shrink-0" />
                      ) : (
